...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.selectFileButton.setGeometry(QRect(500, 50, 61, 41))
        ...
        self.generateButton.setGeometry(QRect(640, 50, 61, 41))
        ...
        self.exportInvoiceButton.setGeometry(QRect(570, 50, 61, 41))
        ...
        self.plainTextEdit.setGeometry(QRect(50, 120, 661, 441))
        ...
        self.menubar.setGeometry(QRect(0, 0, 777, 33))
...
"}", None))
        ...
        self.generateButton.setText(QCoreApplication.translate("MainWindow", u"\uc791\uc5c5", None))
        self.exportInvoiceButton.setText(QCoreApplication.translate("MainWindow", u"\uc1a1\uc7a5", None))
