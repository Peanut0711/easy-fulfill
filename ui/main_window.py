...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_invoice.setGeometry(QRect(110, 30, 331, 40))
        ...
        self.pushButton_load_invoice.setGeometry(QRect(490, 30, 111, 40))
        self.plainTextEdit_invoice = QPlainTextEdit(self.tab_3)
        self.plainTextEdit_invoice.setObjectName(u"plainTextEdit_invoice")
        self.plainTextEdit_invoice.setGeometry(QRect(30, 90, 641, 421))
...
"}", None))
        ...
        self.label_invoice.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
